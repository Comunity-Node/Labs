...
contract CoFinanceFactory {
    ...
    mapping(address => address) public collateralLockPools;
    ...
    function createPool(
        ...
        collateralLockPools[address(pool)] = address(collateralLockPool);
    ...
    function getCollateralLockPool(address poolAddress) external view returns (address) {
        return collateralLockPools[poolAddress];
    }
}
